<div class="movies index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('mylist_id'); ?></th>
			<th><?php echo $this->Paginator->sort('smid'); ?></th>
			<th><?php echo $this->Paginator->sort('threadid'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($movie['Movie']['smid']); ?>&nbsp;</td>
		<td><?php echo h($movie['Movie']['threadid']); ?>&nbsp;</td>
